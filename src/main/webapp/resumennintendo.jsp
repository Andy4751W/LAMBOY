...
<body style="background-color: rgb(0, 0, 0);">
    ...
    <img src="img/NINTENDO SWITCH.jpeg" alt="Nintendo Switch" />
    ...
    <p style="color: azure;">
        Total a pagar . . . . . . . . . . $7850.00
    </p>

    <div class="botones">
        <a href="PAGOS.jsp" class="btn-1" style="color: aliceblue">Pagar</a>
